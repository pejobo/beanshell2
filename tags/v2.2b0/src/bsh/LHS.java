...
//    }
    ...
    /**
     * Unambiguous constructor for an index lhs value.
     * 
     * @param target The target object or array
     * @param keyIndex The key value or array index
     */
...
//            }
            Class type1 = (object != null) ? object.getClass() : null;
            Class type2 = (index != null) ? index.getClass() : null;
            getAtMethod = OperatorProvider.findMethod(nameSpace,OperatorType.GETAT.getMethodName(), getAtMethod, false, type1, type2);
            if (getAtMethod != null) {
                return getAtMethod.eval(object, index);
            }
            else if (index instanceof Integer) {
                try {
                    return Reflect.getIndex(object, ((Integer) index).intValue());
                }
                catch (Exception e) {
                    throw new UtilEvalError("Array access: " + e);
                }
...
//            }
            Object val2 = Primitive.unwrap(val);
            Class type1 = (object != null) ? object.getClass() : null;
            Class type2 = (index != null) ? index.getClass() : null;
            Class type3 = (val2 != null) ? val2.getClass() : null;
            putAtMethod = OperatorProvider.findMethod(nameSpace,OperatorType.PUTAT.getMethodName(), putAtMethod, false, type1, type2, type3);
            if (putAtMethod != null) {
                return putAtMethod.eval(object, index, val2);
            }
            else if (object.getClass().isArray() && index instanceof Integer) {
                try {
                    Reflect.setIndex(object, ((Integer) index).intValue(), val);
                }
                catch (UtilTargetError e1) { // pass along target error
                    throw e1;
                }
